...
### 本项目需要配合  
微信小程序项目：GitHub: https://github.com/ShunGangHu/es-wa.git

管理后台项目：GitHub:  https://github.com/ShunGangHu/es-manager.git 

### 本地开发环境配置
+ 克隆项目到本地
```
git clone https://github.com/ShunGangHu/es-server.git
```
...
### 项目截图
请参考微信小程序项目：https://github.com/ShunGangHu/es-wa.git
...
- 项目地址  
  ...
  后台管理：https://github.com/ShunGangHu/es-manager.git 
